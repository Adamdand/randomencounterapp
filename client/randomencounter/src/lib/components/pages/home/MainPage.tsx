...
import DetailedFight from "../detailfight/DetailFight";
import ItemSearch from "../itemsearch/ItemSearch";
import MonsterSearch from "../monstersearch/MonsterSearch";
import QuickFight from "../quickfight/QuickFight";
  ...
  return (
    <Box className={classes.root} sx={{ width: "100%" }}>
      ...
      >
        ...
        {gameType === "Monster Search" && <MonsterSearch />}
        {gameType === "Item Search" && <ItemSearch />}
        {gameType === "Random Item" && <RandomItem />}
        {gameType === "Quick Fight" && <QuickFight />}
        {gameType === "Detailed Fight" && <DetailedFight />}
      </Box>
    </Box>
  );
};
