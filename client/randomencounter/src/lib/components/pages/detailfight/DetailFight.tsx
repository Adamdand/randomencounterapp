...
import ActionsInfo from "../../common/ActionsInfo";
...
import SetUpInfo from "@/components/common/SetUpInfo";
import CreateNewPlayer from "@/components/common/CreateNewPlayer";
